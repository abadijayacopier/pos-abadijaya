...
const seedData = () => {
    ...
    // ---- Products (ATK) ----
    db.setAll('products', [
        { id: 'p1', code: 'ATK-001', name: 'Pulpen Pilot BP-1RT', categoryId: 'c1', buyPrice: 3500, sellPrice: 5000, stock: 50, minStock: 10, unit: 'pcs', emoji: '🖊️' },
        { id: 'p2', code: 'ATK-002', name: 'Pulpen Snowman V5', categoryId: 'c1', buyPrice: 6000, sellPrice: 8500, stock: 35, minStock: 10, unit: 'pcs', emoji: '🖊️' },
        { id: 'p3', code: 'ATK-003', name: 'Pensil 2B Faber Castell', categoryId: 'c1', buyPrice: 2500, sellPrice: 4000, stock: 40, minStock: 10, unit: 'pcs', emoji: '✏️' },
        { id: 'p4', code: 'ATK-004', name: 'Buku Tulis 58 lembar', categoryId: 'c2', buyPrice: 3000, sellPrice: 4500, stock: 30, minStock: 10, unit: 'pcs', emoji: '📓' },
        { id: 'p5', code: 'ATK-005', name: 'Buku Gambar A3', categoryId: 'c2', buyPrice: 5000, sellPrice: 7500, stock: 20, minStock: 5, unit: 'pcs', emoji: '🎨' },
        { id: 'p6', code: 'ATK-006', name: 'Kertas HVS A4 70gsm (Rim)', categoryId: 'c6', buyPrice: 38000, sellPrice: 55000, stock: 15, minStock: 5, unit: 'rim', emoji: '📄' },
        { id: 'p7', code: 'ATK-007', name: 'Kertas HVS F4 70gsm (Rim)', categoryId: 'c6', buyPrice: 42000, sellPrice: 60000, stock: 12, minStock: 5, unit: 'rim', emoji: '📄' },
        { id: 'p8', code: 'ATK-008', name: 'Kertas HVS A3 (Rim)', categoryId: 'c6', buyPrice: 75000, sellPrice: 95000, stock: 8, minStock: 3, unit: 'rim', emoji: '📄' },
        { id: 'p9', code: 'ATK-009', name: 'Map Plastik Kancing F4', categoryId: 'c3', buyPrice: 2000, sellPrice: 3500, stock: 60, minStock: 15, unit: 'pcs', emoji: '📁' },
        { id: 'p10', code: 'ATK-010', name: 'Amplop Coklat Besar', categoryId: 'c3', buyPrice: 500, sellPrice: 1000, stock: 200, minStock: 50, unit: 'pcs', emoji: '✉️' },
        { id: 'p11', code: 'ATK-011', name: 'Amplop Putih Kecil', categoryId: 'c3', buyPrice: 300, sellPrice: 500, stock: 150, minStock: 50, unit: 'pcs', emoji: '✉️' },
        { id: 'p12', code: 'ATK-012', name: 'Stapler HD-10', categoryId: 'c4', buyPrice: 15000, sellPrice: 22000, stock: 8, minStock: 3, unit: 'pcs', emoji: '📎' },
        { id: 'p13', code: 'ATK-013', name: 'Isi Staples No. 10', categoryId: 'c4', buyPrice: 3000, sellPrice: 5000, stock: 25, minStock: 10, unit: 'box', emoji: '📎' },
        { id: 'p14', code: 'ATK-014', name: 'Lem Kertas UHU 8g', categoryId: 'c5', buyPrice: 4000, sellPrice: 6500, stock: 18, minStock: 5, unit: 'pcs', emoji: '🧴' },
        { id: 'p15', code: 'ATK-015', name: 'Selotip Bening 1/2 inch', categoryId: 'c5', buyPrice: 3000, sellPrice: 5000, stock: 20, minStock: 5, unit: 'roll', emoji: '📦' },
        { id: 'p16', code: 'ATK-016', name: 'Penggaris 30cm', categoryId: 'c4', buyPrice: 2000, sellPrice: 3500, stock: 15, minStock: 5, unit: 'pcs', emoji: '📏' },
        { id: 'p17', code: 'ATK-017', name: 'Penghapus Faber Castell', categoryId: 'c4', buyPrice: 2000, sellPrice: 3500, stock: 25, minStock: 10, unit: 'pcs', emoji: '🧽' },
        { id: 'p18', code: 'ATK-018', name: 'Spidol Snowman Board Marker', categoryId: 'c1', buyPrice: 6000, sellPrice: 9000, stock: 12, minStock: 5, unit: 'pcs', emoji: '🖍️' },
        { id: 'p19', code: 'ATK-019', name: 'Tip-ex Correction Tape', categoryId: 'c4', buyPrice: 5000, sellPrice: 7500, stock: 14, minStock: 5, unit: 'pcs', emoji: '📝' },
        { id: 'p20', code: 'ATK-020', name: 'Toner Canon NPG-68', categoryId: 'c7', buyPrice: 85000, sellPrice: 120000, stock: 6, minStock: 2, unit: 'pcs', emoji: '🖨️' },
    ]);
